...
// getting the total price of the item i the cart
...
if($count_brands==0){
echo"<h2>There is no product where found associated to this brand</h2>";
}
